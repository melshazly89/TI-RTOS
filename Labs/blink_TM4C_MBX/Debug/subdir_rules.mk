...
build-1133386609:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1133386609-inproc

build-1133386609-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1133386609 ../empty.cfg
configPkg/compiler.opt: build-1133386609
configPkg/: build-1133386609
