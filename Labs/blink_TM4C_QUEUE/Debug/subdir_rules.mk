...
build-1725735889:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1725735889-inproc

build-1725735889-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1725735889 ../empty.cfg
configPkg/compiler.opt: build-1725735889
configPkg/: build-1725735889
